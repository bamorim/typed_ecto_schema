defmodule TypedEctoSchema do
  ...
  It ends up in something like this:
    ...
    TODO: Add some examples of schema options.
    ...
    TODO: Document how we handle primary keys
    ...
    TODO: Document how we handle timestamps (note: wo don't, right now)

    ## Not Supported Features

    TODO: Document what we don't support yet.
  """
